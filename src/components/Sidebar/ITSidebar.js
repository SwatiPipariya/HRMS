...
const routes = [
  ...
  },
  {
    ...
    icon: <FaUserEdit  id="CandidateAssigned" />,
  },
//   {
//     path: "/file-manager",
//     name: "File Manager",
...
const ITSidebar = ({ children }) => {
  ...
  useEffect(() => {
    ...
    socket.on('NewCandidateAssigned' ,(data) => {
      console.log(data.data);

      playAudio();
      
      NewCandidateAssignedNotification( );
      // notificationBAr();
  ...
  const NewCandidateAssignedNotification = () => {




   const notify =  document.getElementById('CandidateAssigned')
   notify.classList.add('CandidateAssigned-text');
  //  notify.style.color = 'green'
   // Add click event listener to change color back to white
   notify.addEventListener('click', () => {
       notify.classList.remove('CandidateAssigned-text');
   });
