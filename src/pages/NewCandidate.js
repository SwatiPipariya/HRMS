  ...
  return (
    <div style={{ marginLeft: '70px', display: 'flex', justifyContent: 'center', paddingRight: '70px' }}>
      ...
      <div style={{ width: '80%', height: 'max-content' }}>
        ...
        {/* <button type="button" className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Swich to Second Attempt</button> */}
        ...
        {userExist && userExist.exists && <>
          ...
          <button type="button" className='epicOne ' onClick={uploadFile}>Upload</button>
          </div>
        </>}
      </div>
